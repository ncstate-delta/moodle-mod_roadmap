...
class restore_roadmap_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        // Roadmap only has one structure step.
        $this->add_step(new restore_roadmap_activity_structure_step('roadmap_structure', 'roadmap.xml'));
    }
     ...
     * by the restore_log_processer when restoring
     * roadmap logs. It must return one array
