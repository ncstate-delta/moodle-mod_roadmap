...
define(['core/yui'], function(Y) {
    ...
    var dialogue = function(title, content, afterShow, afterHide, wide) {
        M.util.js_pending('mod_roadmap/dialogue:dialogue');
        ...
        Y.use('moodle-core-notification', 'timers', function() {
            ...
            parent.yuiDialogue.before('visibleChange', function() {
                M.util.js_pending('mod_roadmap/dialogue:before:visibleChange');
            });
                ...
                if (e.newVal) {
                    ...
                    if ((typeof afterShow !== 'undefined')) {
                        Y.soon(function() {
                            ...
                            M.util.js_complete('mod_roadmap/dialogue:before:visibleChange');
                        });
                    } else {
                        M.util.js_complete('mod_roadmap/dialogue:before:visibleChange');
                    }
            ...
            M.util.js_complete('mod_roadmap/dialogue:dialogue');
        });
    };
